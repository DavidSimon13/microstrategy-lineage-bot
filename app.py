...
def load_dataset(
    ...
    """
    Carga y mantiene en cache
    el dataset de Platform Analytics.
    """
...
def analyze_object(
    ...
    """
    Ejecuta el motor real de lineage.
    """
...
with header_text:
    ...
    st.caption(
        "MicroStrategy  •  Platform Analytics  •  AWS"
    )
...
if page == "Inicio":
    ...
    st.markdown(
        ...
        <div class="maya-section-title">
            Maya
        </div>

        Este espacio permite localizar objetos
        de MicroStrategy, recorrer su lineage
        y determinar las tablas físicas que
...
# ============================================================
    ...
    if not result:
        ...
        st.info(
            "Ejecuta primero un analisis."
        )

    else:

        obj = (
            result["classified"].get(
                "start_object",
                {}
            )
        )
